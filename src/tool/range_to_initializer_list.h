//
// Created by nick on 18-02-20.
//

#ifndef SECRET_MESSAGE_RANGE_TO_INITIALIZER_LIST_H
#define SECRET_MESSAGE_RANGE_TO_INITIALIZER_LIST_H
...
#endif //SECRET_MESSAGE_RANGE_TO_INITIALIZER_LIST_H
